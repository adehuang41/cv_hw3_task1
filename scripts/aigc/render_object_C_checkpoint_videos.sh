...
TRIAL_DIR=${AIGC_OBJECT_C_TRIAL_DIR:?AIGC_OBJECT_C_TRIAL_DIR is required}
...
ZERO123_MODEL=${AIGC_ZERO123_MODEL:-"$PROJECT_ROOT/data/interim/cache/huggingface/hub/models--bennyguo--zero123-diffusers/snapshots/b5289c24d8549e3a4737d0c34ab1347e5f074fbe"}
MAX_STEPS=${AIGC_OBJECT_C_COARSE_MAX_STEPS:-10000}
VIDEO_INTERVAL=${AIGC_OBJECT_C_COARSE_VIDEO_INTERVAL:-1000}
INCLUDE_FINAL=${AIGC_OBJECT_C_COARSE_RENDER_FINAL:-1}
POLL_SECONDS=${AIGC_OBJECT_C_COARSE_VIDEO_POLL_SECONDS:-20}
CUDA_DEVICE=${AIGC_OBJECT_C_VIDEO_CUDA_DEVICE:-${CUDA_DEVICE:-$( "$AIGC_ENV/bin/python" "$PROJECT_ROOT/scripts/aigc/select_cuda_device.py" )}}
MONITOR_LOG="$TRIAL_DIR/checkpoint_video_render.log"
...
log "started trial_dir=$TRIAL_DIR cuda=$CUDA_DEVICE interval=$VIDEO_INTERVAL max_steps=$MAX_STEPS include_final=$INCLUDE_FINAL prompt=$PROMPT negative_prompt=$NEGATIVE_PROMPT"
...
log "finished; rendered or verified Object C checkpoint videos"
